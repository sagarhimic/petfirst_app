...
def send_grooming_booking_notification(
    db: Session,
    booking_id: int,
    ...
    if user_type == "franchise":
        ...
        name = "Pet-First"
        template_id = 13
        purpose = "PET First Grooming Booking"
        link = f"franchise/get-booking-details/{booking_id}"

        title = (
            f"Customer booked Grooming Service. "
    ...
    # ===================================================
        ...
        template_id = 10
        purpose = "PET Customer Grooming Booking"
        link = f"customer/get-booking-details/{booking_id}"

        title = (
            f"Dear {name}, you confirmed Grooming Service "
            f"Booking ID - {booking_id}"
        )
