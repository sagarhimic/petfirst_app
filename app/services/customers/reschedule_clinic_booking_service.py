...
from app.utils.Notifications.reschedule_clinic_notification import send_reschedule_clinic_booking_notification

def reschedule_clinic_booking_service(
    db: Session,
    user_id: int,
    booking_id: int,
    data: dict
    ...
    try:
        ...
        history = BookingHistoryReschedule(
            ...
            # booking_to=previous.booking_to,
        ...
        # -----------------------------
        # Send to Doctor
        send_reschedule_clinic_booking_notification(
            db,
            booking_id=booking_id,
            user_type="doctor"
        )
